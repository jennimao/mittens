...
def on_plane(x,y,z,pair1,pair2):
     #find normal vector of plane:
        ...
        if pair1[0] == pair2[0]:
             intersection_point = (points_global[pair1[0]][0,0], points_global[pair1[0]][0,1],points_global[pair1[0]][0,2])
        if pair1[1] == pair2[0]:
             intersection_point = (points_global[pair1[1]][0,0], points_global[pair1[1]][0,1],points_global[pair1[1]][0,2])
        if pair1[0] == pair2[1]:
             intersection_point = (points_global[pair1[0]][0,0], points_global[pair1[0]][0,1],points_global[pair1[0]][0,2])
        if pair1[1] == pair2[1]:
             intersection_point = (points_global[pair1[1]][0,0], points_global[pair1[1]][0,1],points_global[pair1[1]][0,2])
        ...
        line1_vector = (points_global[pair1[0]][0,0] -points_global[pair1[1]][0,0], points_global[pair1[0]][0,1] -points_global[pair1[1]][0,1], points_global[pair1[0]][0,2] -points_global[pair1[1]][0,2])
        line2_vector =  (points_global[pair2[1]][0,0] -points_global[pair2[0]][0,0], points_global[pair2[1]][0,1] -points_global[pair2[0]][0,1], points_global[pair2[1]][0,2] -points_global[pair2[0]][0,2])
...
def on_cube(x,y,z):
    ...
    max_x = np.max(points_array[0][:, 0])
    min_x = np.min(points_array[0][:, 0])
    max_y = np.max(points_array[0][:, 1])
    min_y = np.min(points_array[0][:, 1])
    max_z = np.max(points_array[0][:, 2])
    min_z = np.min(points_array[0][:, 2])
